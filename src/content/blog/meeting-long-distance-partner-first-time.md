...
faqs:
  - question: "Is it normal to be nervous about meeting your long-distance partner for the first time?"
    answer: "Completely normal. You're about to meet someone you already love in a way you've never experienced them: in person, in three dimensions, with all the small physical realities (height, smell, how they laugh out loud) that a screen filters out. The nerves aren't a warning sign. They're proof it matters."
  - question: "What if it feels awkward when we first meet in person?"
    answer: "Expect the first few hours to feel slightly off. You've spent months relating through a screen, and your brain has to recalibrate to the physical person. This 'uncanny valley' phase usually passes within a few hours to a day as your real-life rhythm syncs up. Awkwardness at the start is not a verdict on the relationship; it's a normal adjustment."
  - question: "How long should the first visit be?"
    answer: "If you can, aim for 5-10 days. Shorter than about four days and you're saying goodbye before you've relaxed; much longer than two weeks for a first visit can be intense before you've built in-person habits. The goal is enough time to have an ordinary day together, like grocery shopping or a lazy morning, not just a highlight reel."
  - question: "What should we do on the first visit?"
    answer: "Mix one or two real plans with lots of unstructured, ordinary time. The magic of a first visit isn't the big date. It's discovering you're just as easy together doing nothing. Don't over-schedule. Leave room to cook a meal, nap, run an errand, and simply exist in the same room."
  - question: "How do we handle the goodbye after meeting for the first time?"
    answer: "Plan the next visit before this one ends. Having a date on the calendar changes the goodbye from 'when will I see you again?' to 'see you in six weeks.' Expect a post-visit slump for a few days afterward; it's grief, and it's normal. Be gentle with each other through it."
---

Before the first visit, agree on where you will stay, sleeping arrangements, money, transport, and how much time you want alone. Keep control of your own travel home and share the itinerary with someone you trust. Then leave the first day loose. Many couples need a few hours to adjust to being together in person.

You've talked every day for months. You've seen their face on a screen so many times you could draw it from memory. You know their voice, their laugh, and the way they go quiet when they're tired. And yet you've never been in the same room, hugged them, or sat in comfortable silence together.
...
Meeting your long-distance partner for the first time can feel thrilling and terrifying at once. Here is what tends to happen, so you can arrive with realistic expectations instead of grading the visit against a movie scene.
...
You are about to meet someone you genuinely love in a form you've never experienced them in. Your relationship has been real, but it's been *mediated*, filtered through a screen that edits out height, scent, touch, and the way someone moves through a room. Some recalibration is inevitable.
...
- **Stay somewhere with privacy** if you can. Meeting family or roommates and each other for the first time in the same 48 hours is a lot. Give the two of you a soft landing first.
...
- **Talk about money up front**, including who is covering what for the trip, so it is not a weird undercurrent.
...
Whatever you're imagining the first meeting will be, it will be different, and that's good. Real is always a little messier than the fantasy. The awkward first hour, the quieter-than-expected airport hug, and the ordinary Tuesday you spend doing nothing together are the real beginning.
